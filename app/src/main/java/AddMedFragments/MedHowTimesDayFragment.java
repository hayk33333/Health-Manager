...
public class MedHowTimesDayFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                addMedicationActivity.hideHowTimesDayFragment();
            }
        });
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                addHowTimesDayToDB(String.valueOf(numberPicker.getValue()));
    ...
    private void addHowTimesDayToDB(String howTimesDay) {
        ...
        medData.put("howTimesDay", howTimesDay);
        ...
        medsCollection
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        System.out.println("Значение '" + howTimesDay + "' успешно добавлено в коллекцию 'meds'!");
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        System.out.println("Ошибка при добавлении значения '" + howTimesDay + "' в коллекцию 'meds': " + e.getMessage());
                    }
                });
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_med_how_times_day, container, false);
    }
}